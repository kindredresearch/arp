...
def learn(env, policy_fn, *,
    ...
    compute_losses = U.function([ob, ac, atarg, past_x, update_mask], losses)
    compute_lossandgrad = U.function([ob, ac, atarg, past_x, update_mask], losses + [U.flatgrad(optimgain, var_list)])
    compute_fvp = U.function([flat_tangent, ob, ac, atarg, past_x, update_mask], fvp)
    ...
    # ----------------------------------------
    seg_gen = traj_segment_generator(pi, env, timesteps_per_batch, stochastic=True, ar=ar)
    ...
    while True:
        ...
        args = seg["ob"], seg["ac"], atarg, past_x, update_mask
